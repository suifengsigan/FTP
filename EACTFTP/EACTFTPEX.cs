...
namespace TOOL
{
    public class EACTFTPEX:EACTFTP
    {
        public EACTFTPEX(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword, bool SSL)
            : base(FtpServerIP, FtpRemotePath, FtpUserID, FtpPassword, SSL)
        { }
        public EACTFTPEX(string FtpServerIP, int FtpServerPort, string FtpRemotePath, string FtpUser, string FtpPassword)
